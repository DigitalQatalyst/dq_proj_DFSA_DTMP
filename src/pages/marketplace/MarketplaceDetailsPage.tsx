        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          ...
          <div className="flex flex-col items-start max-w-3xl py-8">
            ...
            <div className="flex items-center justify-between w-full mb-4">
              ...
              <button onClick={handleToggleBookmark} className={`p-1.5 rounded-full ${isBookmarked ? 'bg-yellow-100 text-yellow-600' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'}`} aria-label={isBookmarked ? 'Remove bookmark' : 'Add bookmark'} title={isBookmarked ? 'Remove bookmark' : 'Add bookmark'}>
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="hidden lg:block lg:col-span-4">
            <div className="sticky top-[96px]">
              {isFloatingCardVisible && <SummaryCard isFloating={isVisible} />}
            </div>
          </div>
        </div>
      </div>
