        ...
        <div className="space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-md p-4 sm:p-6">
                ...
                <p className="text-gray-600 mb-4">
                    Access our API documentation, SDKs, and developer tools to integrate
                    with our platform.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <a
                        href="#"
                        className="bg-white p-4 border border-gray-200 rounded-md hover:bg-gray-50 transition-colors"
                    >
                        <h4 className="text-base font-medium text-blue-600">
                            API Documentation
                        </h4>
                    ...
                    <a
                        href="#"
                        className="bg-white p-4 border border-gray-200 rounded-md hover:bg-gray-50 transition-colors sm:col-span-2 lg:col-span-1"
                    >
                        <h4 className="text-base font-medium text-blue-600">
                            Code Samples
                        </h4>
