...
export function Header({
  ...
  return (
    <>
      {/* Always present spacer to prevent layout shift */}
      <div className="h-16"></div>
      <header
        className={`flex items-center w-full h-16 fixed top-0 left-0 right-0 z-40 transition-shadow duration-300 ${
          isSticky
            ? "shadow-lg backdrop-blur-sm bg-gradient-to-r from-teal-500/95 via-blue-500/95 to-purple-600/95"
      ...
      >
        ...
        <Link
          to="/"
          className="bg-gradient-to-r from-teal-600 to-teal-500 text-white py-2 px-4 flex items-center h-16"
        >
          <img src="/mzn_logo.svg" alt="MZN Logo" className="h-10" />
        </Link>
        {/* Main Navigation */}
