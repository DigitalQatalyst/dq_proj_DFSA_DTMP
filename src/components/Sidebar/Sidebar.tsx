...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    const getMenuItems = (): MenuItem[] => {
        ...
        items.push(
            { id: 'essentials', label: 'ESSENTIALS', category: 'category' } as MenuItem,
            {
                id: 'profile',
                label: 'Profile',
                icon: <User size={20} />,
            ...
            { id: 'transactions', label: 'TRANSACTIONS', category: 'category' } as MenuItem,
            {
                id: 'requests',
                label: 'Requests',
                icon: <Send size={20} />,
            ...
            { id: 'settings-support', label: 'Settings & Support', category: 'category' } as MenuItem,
            {
                id: 'settings',
                label: 'Settings',
    ...
    return (
        <div
            className={`fixed lg:static inset-y-0 left-0 z-30 w-64 bg-gray-50 border-r border-gray-200 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'} lg:w-60 overflow-y-auto`}
            data-id={dataId}
        >
