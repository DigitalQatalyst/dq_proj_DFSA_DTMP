...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div
      className={`fixed lg:static left-0 top-16 bottom-0 z-40 w-64 bg-gray-50 border-r border-gray-200 transform transition-transform duration-300 ease-in-out ${
