  ...
  switch (marketplaceType) {
    case 'courses':
      return [{
        ...
        description: 'Learn essential business strategy concepts and frameworks to drive your organization forward.',
        ...
        description: 'Master the fundamentals of digital marketing to grow your business online presence and reach.',
        ...
        description: 'Develop financial literacy and management skills essential for business success and growth.',
...
export const getFallbackItemDetails = (marketplaceType: string, itemId: string) => {
  ...
  return {
    ...
    description: 'This is a sample service description that appears when the requested item cannot be found.',
    provider: providers[0],
    ...
    details: ['Feature 1: Sample feature description', 'Feature 2: Another sample feature', 'Feature 3: Yet another feature'],
    learningOutcomes: ['Outcome 1: Sample learning outcome', 'Outcome 2: Another learning outcome', 'Outcome 3: Final learning outcome']
  };
};